local dyes = {
	...
	{"grey",       "Grey",		true,  "#aaa", default.LIGHT_MAX},
	{"black",      "Black",		true,  "#000", default.LIGHT_MAX},
	...
	{"brown",      "Brown",		true,  "#882", default.LIGHT_MAX},
	{"pink",       "Pink",		true,  "#f48", default.LIGHT_MAX},
	{"dark_grey",  "Dark Grey",	true,  "#444", default.LIGHT_MAX},
	{"dark_green", "Dark Green",true,  "#1a1", default.LIGHT_MAX},
	{"dark_blue",  "Dark Blue",	false, "#11a", default.LIGHT_MAX},
	{"dark_red",   "Dark Red",	false, "#a11", default.LIGHT_MAX},
